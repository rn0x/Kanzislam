...
var Coordinates = /*#__PURE__*/ _createClass(function Coordinates(
  latitude,
  longitude
) {
...
var Astronomical = {
  ...
  ascendingLunarNodeLongitude: function ascendingLunarNodeLongitude(
    julianCentury
  ) {
    var T = julianCentury;
    /* Equation from Astronomical Algorithms page 144 */
  ...
  solarEquationOfTheCenter: function solarEquationOfTheCenter(
    julianCentury,
    meanAnomaly
  ) {
    var T = julianCentury;
  ...
  apparentSolarLongitude: function apparentSolarLongitude(
    julianCentury,
    meanLongitude
  ) {
    var T = julianCentury;
  ...
  meanObliquityOfTheEcliptic: function meanObliquityOfTheEcliptic(
    julianCentury
  ) {
    var T = julianCentury;
  ...
  apparentObliquityOfTheEcliptic: function apparentObliquityOfTheEcliptic(
    julianCentury,
  ...
  nutationInLongitude: function nutationInLongitude(
    julianCentury,
    solarLongitude,
    lunarLongitude,
    ascendingNode
  ...
  nutationInObliquity: function nutationInObliquity(
    julianCentury,
    solarLongitude,
    lunarLongitude,
    ascendingNode
  ...
  altitudeOfCelestialBody: function altitudeOfCelestialBody(
    observerLatitude,
    declination,
    localHourAngle
  ) {
  ...
  approximateTransit: function approximateTransit(
    longitude,
    siderealTime,
    rightAscension
  ) {
  ...
  correctedTransit: function correctedTransit(
    approximateTransit,
    longitude,
    siderealTime,
    rightAscension,
  ...
  correctedHourAngle: function correctedHourAngle(
    approximateTransit,
    angle,
    coordinates,
    afterTransit,
    ...
    var H = Theta - Lw - a;
    var h = Astronomical.altitudeOfCelestialBody(
  ...
  seasonAdjustedMorningTwilight: function seasonAdjustedMorningTwilight(
    latitude,
    dayOfYear,
    year,
    sunrise
  ...
  seasonAdjustedEveningTwilight: function seasonAdjustedEveningTwilight(
    latitude,
    dayOfYear,
    year,
    sunset,
...
var SolarCoordinates = /*#__PURE__*/ _createClass(function SolarCoordinates(
  julianDay
) {
  ...
  var EpsilonApparent = degreesToRadians(
...
var SolarTime = /*#__PURE__*/ (function () {
  function SolarTime(date, coordinates) {
    ...
    var julianDay = Astronomical.julianDay(
      date.getFullYear(),
      date.getMonth() + 1,
      date.getDate(),
      0
...
var aqrabBaladResolver = function aqrabBaladResolver(
  coordinates,
  date,
  latitude
) {
  ...
  var tomorrowSolarTime = new SolarTime(
    tomorrow,
    _objectSpread2(
      _objectSpread2({}, coordinates),
      {},
...
var polarCircleResolvedValues = function polarCircleResolvedValues(
  resolver,
  date,
  coordinates
) {
...
var CalculationMethod = {
  ...
  Dubai: function Dubai() {
    ...
    params.methodAdjustments = _objectSpread2(
      _objectSpread2({}, params.methodAdjustments),
      {},
      {
        sunrise: -3,
        dhuhr: 3,
...
var PrayerTimes = /*#__PURE__*/ (function () {
  ...
  function PrayerTimes(coordinates, date, calculationParameters) {
    ...
    if (
      ...
      var resolved = polarCircleResolvedValues(
        polarCircleResolver,
        date,
        coordinates
      );
      ...
      dhuhrTime = (_TimeComponents = new TimeComponents(
        solarTime.transit
      )).utcDate.apply(_TimeComponents, dateComponents);
      sunriseTime = (_TimeComponents2 = new TimeComponents(
        solarTime.sunrise
      )).utcDate.apply(_TimeComponents2, dateComponents);
      sunsetTime = (_TimeComponents3 = new TimeComponents(
        solarTime.sunset
      )).utcDate.apply(_TimeComponents3, dateComponents);
    ...
    ).utcDate(date.getFullYear(), date.getMonth(), date.getDate()); // special case for moonsighting committee above latitude 55
    ...
    if (calculationParameters.maghribAngle) {
      var angleBasedMaghrib = new TimeComponents(
